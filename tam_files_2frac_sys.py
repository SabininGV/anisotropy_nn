...
def anisotropic_parameters(dn1,dt1,alpha1, dn2,dt2,alpha2):
    return "lh= '0 (base)' ls= 196608 lac= 0.000000 las= 0.000000 laa= 2000.000000 lab=1000.000000 tf=0.000000 tg=0.000000 tf1={:.6f} tf2={:.6f} tf3=0.000000 tdn1={:.6f} tdn2={:.6f} tdn3=0.000000 tdt1={:.6f} tdt2={:.6f} tdt3=0.000000 tfb=2 ".format(alpha1,alpha2,dn1,dn2,dt1,dt2)
...
df.to_csv(str(cwd) + '\\frac_params_2frac_sys.csv',index=None, header=['dn1','dt1','alpha1','dn2','dt2','alpha2'])
